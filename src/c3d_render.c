...
/*   Updated: 2023/02/02 16:42:27 by Yoshihiro K      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	c3d_render_imgline(t_img *img, int src_id, t_coord *dst, t_coord *src)
{
	(void)img;
	(void)src_id;
	(void)src;
...
void	c3d_render_visible(t_mlx *mlx)
{
	...
	c3d_render_imgline(mlx->img, IDX_NORTH, &dst, &src);
}
