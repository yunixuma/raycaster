...
/*   Updated: 2023/02/21 11:07:14 by Yoshihiro K      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	const_height = (HEIGHT_VISION >> 1) / ft_math_sin_deg(mlx->game.fov / 2) / HEIGHT_VISION * WIDTH_VISION;
...
//	dst.y = (HEIGHT_VISION >> 1) - sin(atan((1 - mlx->game.coord.z) / dist)) * const_height;
...
//	src.y = (HEIGHT_VISION >> 1) - dst.y + sin(atan(mlx->game.coord.z / dist)) * const_height;
